  ...
  return (
    <div className='bg-white '>
         <Navbar key={expand} expand={expand} className="mb-3 min-h-[10vh] my-auto px-xl-3">
          <Container fluid>
            <Navbar.Brand href="#" className='poppins'>DashBoard</Navbar.Brand>
...
<div className={`${plus? "d-block":"d-none"} position-absolute rounded-lg border-1 p-2 w-44 right-0 m-1 `}>
        <button className=' p-2 hover:bg-slate-50 transition duration-300 hover:text-violet-600  w-full text-start rounded '>Add Product </button>
        <button className=' p-2 hover:bg-slate-50 transition duration-300 hover:text-violet-600  w-full text-start rounded '>Add Category </button>
        <button className=' p-2 hover:bg-slate-50 transition duration-300 hover:text-violet-600  w-full text-start rounded'>Add Brand </button>
                </div>
            </div>
            ...
            >
              <Offcanvas.Header closeButton>
                <Offcanvas.Title className='px-3' id={`offcanvasNavbarLabel-expand-${expand}`}>
                  DashBoard
                </Offcanvas.Title>
              </Offcanvas.Header>
              <Offcanvas.Body>
  ...
  <path d="M2.97 1.35A1 1 0 0 1 3.73 1h8.54a1 1 0 0 1 .76.35l2.609 3.044A1.5 1.5 0 0 1 16 5.37v.255a2.375 2.375 0 0 1-4.25 1.458A2.37 2.37 0 0 1 9.875 8 2.37 2.37 0 0 1 8 7.083 2.37 2.37 0 0 1 6.125 8a2.37 2.37 0 0 1-1.875-.917A2.375 2.375 0 0 1 0 5.625V5.37a1.5 1.5 0 0 1 .361-.976zm1.78 4.275a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 1 0 2.75 0V5.37a.5.5 0 0 0-.12-.325L12.27 2H3.73L1.12 5.045A.5.5 0 0 0 1 5.37v.255a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0M1.5 8.5A.5.5 0 0 1 2 9v6h1v-5a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5h6V9a.5.5 0 0 1 1 0v6h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1V9a.5.5 0 0 1 .5-.5M4 15h3v-5H4zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1zm3 0h-2v3h2z"/>
                ...
                <button  className={`d-flex hover:bg-slate-100  items-center rounded gap-2 p-3 `}  
