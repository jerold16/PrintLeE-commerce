  ...
  return (
    <div className='poppins min-h-[90vh] bg-slate-50'>
        ...
        <div className='container bg-white mx-auto p-3 rounded '>
          ...
          <div className='w-[400px]'>
            Category
            <select name='' type="text" placeholder='Enter the Product name'   style={{backgroundColor:"#f6f6f6"}}className='p-3 w-full  block my-2 px-3 border-0  rounded outline-none' >
