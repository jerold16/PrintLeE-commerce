  ...
  return (
    <div className='my-10 xl:my-0 flex xl:min-h-[90vh]'>
      <Row className='justify-between  container mx-auto my-auto  '>
        <Col lg={5} className='overflow-hidden cardhover p-0 my-5 relative rounded-3xl '>
         ...
         <h4 className='text-white  text-2xl sm:text-4xl fw-bolder w-3/5 '>Booklet and Broucher</h4>
