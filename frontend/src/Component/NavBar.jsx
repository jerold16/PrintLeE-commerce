...
const NavBar = () => {
  ...
  let { wishList, Allcaetgory } = useContext(Storage)
  let navigate = useNavigate()
  return (
    <div className='bg-white pt-lg-0 sticky-top'>
        ...
        <Container fluid>
          ...
          <div className='transtionuser'>
            ...
            >
              ...
              <Offcanvas.Body>
                <div className='fw-semibold fs-6 fontfam1 lg:w-[60vw]'>
                  <Nav className="justify-content-around scrolledit overflow-x-scroll gap-2 flex-grow-1 pe-3">
                    ...
                    <Nav.Link className='d-lg-none ' onClick={() => navigate('/wishlist')}>WishList</Nav.Link>
                    {
                      Allcaetgory != undefined && Allcaetgory.length > 0 ?
                        ...
                        Allcaetgory.map((x) => {
                          return (
                            <Nav.Link className='' onClick={()=>navigate(`/category/${x.category}`)}>
                                        {x.category}
                            </Nav.Link>
                          )
                        }) : ""
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
            ...
            <div className='mx-3 relative cursor-pointer'>
              ...
              </svg> <span className='badge absolute -top-2 -right-2 bg-red-500 rounded-full text-white'>2</span>
            </div>
            {/* Wishlist */}
